...
const emailSchema = z.object({ labId: z.string(), subject: z.string(), body: z.string(), personalizationNotes: z.array(z.string()), generationMode: z.enum(["ai", "demo"]), model: z.string().nullable() });

export type UserProfile = z.infer<typeof profileSchema>; export type CalendarEvent = z.infer<typeof eventSchema>; export type Admission = z.infer<typeof admissionSchema>; export type DocumentAnalysis = z.infer<typeof documentSchema>; export type Recommendation = z.infer<typeof recommendationSchema>; export type Lab = z.infer<typeof labSchema>; export type EmailDraft = z.infer<typeof emailSchema>;
